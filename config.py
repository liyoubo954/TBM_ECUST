...
class Config(object):
    ...
    TSJY_FIELDS = [
        ...
        "Liquid.Pump.A.OutPres.01", "Liquid.Pump.A.OutPres.02", "Liquid.Pump.A.OutPres.03", "Liquid.Pump.A.OutPres.04", "Liquid.Pump.A.OutPres.05", "Liquid.Pump.A.OutPres.06", "Liquid.Pump.A.OutPres.07", "Liquid.Pump.A.OutPres.08",
