...
--influxdb.database yztl_dz1266_ring
...
2. 在ringclean_yztl项目中`mvn clean package` 打jar包
3. 上传ringclean_yztl的jar包到`http://172.16.105.238:8081/#/overview`
4. 获取ringclean_yztl的jar包id`curl http://localhost:8081/jars`
