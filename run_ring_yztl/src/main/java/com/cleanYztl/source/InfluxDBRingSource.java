...
import com.cleanYztl.config.InfluxDBConfig;
import com.cleanYztl.models.RingCleanData;
...
public class InfluxDBRingSource extends RichSourceFunction<RingCleanData> {
    ...
    private final String sourceDatabase = "yztl_dz1266_ring";
    ...
    private void processHistoryRing(SourceContext<RingCleanData> ctx, Integer ringNumber) throws Exception {
        ...
        String targetDatabase = "yztl_dz1266_cleanRing";
    ...
    public void start(StreamExecutionEnvironment env, String sourceName) throws Exception {
        ...
        // 直接sink到InfluxDB
        sourceStream
            .sinkTo(new com.cleanYztl.sink.influxdb.InfluxDBRingCleanSink(influxDBConfig))
